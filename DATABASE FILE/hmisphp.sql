...
(1, 'Individual Retirement Account', '<p>IRA&rsquo;s are simply an account where you stash your money for retirement...</p>', 'Payable Account', '518703294', '25000'),
(2, 'Equity Bank', '<p>Find <em>bank account</em> stock <em>images</em> in HD and millions...</p>', 'Receivable Account', '753680912', '12566'),
...
(5, 'Sokvisal', 'Sean', 'visal123@gmail.com', '6a01ab61bc2be81e510e72f15389a8be9547e3a3', 'General doctor', 'visal', 'defaultimg.jpg'),
(6, 'Pheakdey', 'Chhun', 'pkd123@gmail.com', 'b19b493768d003d637306e4e90b8a8d3aead4e69', 'General doctor', 'pkd', 'user-default-2-min.png'),
(12, 'Somaly', 'Chey', 'somaly123@gmail.com', '36355b63ac86fe0cb257481a23a5b5962307b426', 'General doctor', 'somaly', 'usric.png');
...
(1, 'Sem Reatrey', 'Flu', '7EW0L', '<ul><li><a href="https://www.medicalnewstoday.com/articles/179211.php">Non-steroidal anti-inflammatory drugs</a> (NSAIDs) such as <a href="https://www.medicalnewstoday.com/articles/161255.php">aspirin</a> or ibuprofen can help bring a fever down...</li></ul>', '<ul><li>If the fever has been caused by a bacterial infection, the doctor may prescribe an <a href="https://www.medicalnewstoday.com/articles/10278.php">antibiotic</a>...</li></ul>', 'K67PL', '2025-01-12 13:32:07'),
(2, 'Seng Chhungyeang', 'Fever', '6P8HJ', '<ul><li>Body temperature</li><li>Blood</li><li>Stool</li><li>Urine</li></ul>', '<ul><li>Body Temperature 67 Degree Celcious(Abnormal)</li><li>Blood - Malaria Bacterial Tested Postive</li><li>Stool - Mucus tested postive</li><li>Urine -Urea Level were 20% higher than normal</li></ul><p><strong>Fever Tested Positive</strong></p>', '9DMN5', '2025-01-12 13:41:07'),
(3, 'Ian Keonary', 'Malaria', 'RAV6C', '<p><strong>Pain areas: </strong>in the abdomen or muscles</p><p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or sweating</p>', '<p><strong>Pain areas: </strong>in the abdomen or muscles -Tested Positive</p><p><strong>Whole body: </strong>chills, fatigue, fever, night sweats, shivering, or sweating - Tested Positive</p>', '90ZNX', '2025-01-13 12:31:48'),
(4, 'Rous Seyha', 'Demo Test', '3Z14K', '<p>demo demo demo demo</p>', '<p>54545</p>', 'G0VZU', '2025-10-20 17:48:05'),
(5, 'Sieng Elis', 'Demo Test', '4TLG0', '<ol><li>Test One</li><li>Test Two</li><li>Test Three</li><li>Test Four</li><li>Test Five</li></ol>', '<ol><li>Result One</li><li>Result Two</li><li>Result Three</li></ol>', 'RA4UM', '2025-10-22 11:01:11');
...
(1, 'ZNXI4', 'Reetrey', 'Phnom penh', '23', 'Malaria', 'RAV6C', '<ul><li>Combination of atovaquone and proguanil (Malarone)</li><li>Quinine sulfate (Qualaquin) with doxycycline (Vibramycin, Monodox, others)</li><li>Mefloquine.</li><li>Primaquine phosphate.</li></ul>', '2025-08-16 10:17:52.1559'),
(2, 'MIA9P', 'Chhunyeang', 'Phnom penh', '23', 'Demo Test', '3Z14K', NULL, '2025-08-16 10:17:57.1559'),
(3, 'F1ZHQ', 'Keonary', 'Phnom penh', '22', 'Demo Test', 'DCRI8', NULL, '2025-08-16 10:18:02.1559');
...
(8, 'Sem', 'Reatry', '02/02/1992', '33', 'DCRI8', 'ផ្លូវរាជបុត្រ សង្កាត់បឹងកក់', '012345678', 'InPatient', '2025-08-16 09:00:00', 'ធ្វើតេស្ត', NULL),
(9, 'Seng', 'Chhunyeang', '01/19/1990', '35', 'ISL1E', 'ផ្លូវមិត្តភាព ភ្នំពេញ', '098765432', 'OutPatient', '2025-08-16 09:15:00', 'ធ្វើតេស្ត', NULL),
(10, 'Ian', 'Keonary', '10/11/2000', '24', '3Z14K', 'ផ្លូវសហព័ន្ធ សង្កាត់ទួលសង្កែ', '093456789', 'InPatient', '2025-08-16 09:30:00', 'ធ្វើតេស្ត', NULL),
(11, 'Rous', 'Seyha', '01/01/1980', '45', 'KU8W4', 'ផ្លូវព្រះមុនីវង្ស ភ្នំពេញ', '016234567', 'OutPatient', '2025-08-16 09:45:00', 'ធ្វើតេស្ត', NULL),
(12, 'Sieng', 'Elis', '11/06/1994', '30', '4TLG0', 'ផ្លូវព្រះសីហនុ សង្កាត់បឹងព្រួញ', '092345678', 'InPatient', '2025-08-16 10:00:00', 'ធ្វើតេស្ត', NULL);
...
(1, 'Khmer soviet friendship Hospital', '2025-08-16 10:00:00', 'Reatrey', '9KXPM', 'Success');
...
(2, 'HUT1B', 'Reatrey', 'N8TI0', 'reatrey@hms.org', '7555', '2025-08-14 10:20:00', 'Paid', '<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit...</p>'),
(3, 'T294L', 'Chhunyeang', 'YDS7L', 'yeang@mail.com', '15500', '2025-08-15 11:45:00', NULL, '<p>demo demo demo demo demo</p>'),
(4, '3UOXY', 'Nary', '5VIFT', 'nary@mail.com', '4150', '2025-08-16 09:30:00', NULL, '<p>This is a demo payroll description for test!!</p>');
...
(1, 'Paracetamol', '134057629', '<ul><li><strong>Paracetamol</strong>, also known as <strong>acetaminophen</strong> and <strong>APAP</strong>, is a medication used to treat <a href=\"https://en.wikipedia.org/wiki/Pain\">pain</a> and <a href=\"https://en.wikipedia.org/wiki/Fever\">fever</a>...</li></ul>', '500', 'Antipyretics', 'Dawa Limited Kenya'),
(2, 'Aspirin', '452760813', '<ul><li><strong>Aspirin</strong>, also known as <strong>acetylsalicylic acid</strong> (<strong>ASA</strong>), is a <a href=\"https://en.wikipedia.org/wiki/Medication\">medication</a> used to reduce <a href=\"https://en.wikipedia.org/wiki/Pain\">pain</a>, <a href=\"https://en.wikipedia.org/wiki/Fever\">fever</a>, or <a href=\"https://en.wikipedia.org/wiki/Inflammation\">inflammation</a>...</li></ul>', '500', 'Analgesics', 'Cosmos Kenya Limited'),
...
(1, 'Antipyretics', 'Cosmos Kenya Limited', '<ul><li>An <strong>antipyretic</strong> is a substance that reduces <a href=\"https://en.wikipedia.org/wiki/Fever\">fever</a>...</li></ul>'),
(2, 'Analgesics', 'Dawa Limited Kenya', '<ul><li><p>An <strong>analgesic</strong> or <strong>painkiller</strong> is any member of the group of <a href=\"https://en.wikipedia.org/wiki/Pharmaceutical_drug\">drugs</a> used to achieve analgesia, relief from <a href=\"https://en.wikipedia.org/wiki/Pain\">pain</a>...</p></li></ul>'),
...
(3, 'Reatrey', '23', '6P8HJ', 'J9DC6', '127001 LocalHost', 'InPatient', '2025-08-14 10:20:00', 'Fever', '<ul><li><a href="https://www.medicalnewstoday.com/articles/179211.php">Non-steroidal anti-inflammatory drugs</a> (NSAIDs) such as <a href="https://www.medicalnewstoday.com/articles/161255.php">aspirin</a> or ibuprofen can help bring a fever down...</li></ul>'),
(4, 'Chhunyeang', '30', 'RAV6C', 'HZQ8J', '12 900 NYE', 'OutPatient', '2025-08-15 11:45:00', 'Malaria', '<ul><li>Combination of atovaquone and proguanil (Malarone)</li><li>Quinine sulfate (Qualaquin) with doxycycline (Vibramycin, Monodox, others)</li><li>Mefloquine.</li><li>Primaquine phosphate.</li></ul>'),
(5, 'Nary', '10', '7EW0L', 'HQC3D', '12 9001 Machakos', 'OutPatient', '2025-08-16 09:30:00', 'Flu', '<ul><li><a href="https://www.google.com/search?client=firefox-b-e&amp;sxsrf=ACYBGNRW3vlJoag6iJInWVOTtTG_HUTedA:1578917913108&amp;q=flu+decongestant&amp;stick=H4sIAAAAAAAAAOMQFeLQz9U3SK5MTlbiBLGMktNzcnYxMRosYhVIyylVSElNzs9LTy0uScwrAQBMMnd5LgAAAA&amp;sa=X&amp;ved=2ahUKEwjRhNzKx4DnAhUcBGMBHYs1A24Q0EAwFnoECAwQHw">Decongestant</a></li></ul>');
...
(2, '8KQWD', 'Pheakdey', 'RAV6C', 'Reatrey', 'Malaria', '2025-08-14 09:15:00', 'Successful'),
...
(1, '6ISKC', 'Cosmos Pharmaceutical Limited', 'Phnom penh', '', 'info@cosmospharmaceuticallimited.com', '0963035186', '<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit...</p>');
...
(3, '1KB9V', '3Z14K', '38', '77', '12', '90/60', '2025-08-16 09:15:22'),
...
-- Indexes
ALTER TABLE `his_accounts` ADD PRIMARY KEY (`acc_id`);
ALTER TABLE `his_admin` ADD PRIMARY KEY (`ad_id`);
ALTER TABLE `his_assets` ADD PRIMARY KEY (`asst_id`);
ALTER TABLE `his_docs` ADD PRIMARY KEY (`doc_id`);
ALTER TABLE `his_equipments` ADD PRIMARY KEY (`eqp_id`);
ALTER TABLE `his_laboratory` ADD PRIMARY KEY (`lab_id`);
ALTER TABLE `his_medical_records` ADD PRIMARY KEY (`mdr_id`);
ALTER TABLE `his_patients` ADD PRIMARY KEY (`pat_id`);
ALTER TABLE `his_patient_transfers` ADD PRIMARY KEY (`t_id`);
ALTER TABLE `his_payrolls` ADD PRIMARY KEY (`pay_id`);
ALTER TABLE `his_pharmaceuticals` ADD PRIMARY KEY (`phar_id`);
ALTER TABLE `his_pharmaceuticals_categories` ADD PRIMARY KEY (`pharm_cat_id`);
ALTER TABLE `his_prescriptions` ADD PRIMARY KEY (`pres_id`);
ALTER TABLE `his_pwdresets` ADD PRIMARY KEY (`id`);
ALTER TABLE `his_surgery` ADD PRIMARY KEY (`s_id`);
ALTER TABLE `his_vendor` ADD PRIMARY KEY (`v_id`);
ALTER TABLE `his_vitals` ADD PRIMARY KEY (`vit_id`);

-- AUTO_INCREMENT
ALTER TABLE `his_accounts` MODIFY `acc_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
ALTER TABLE `his_admin` MODIFY `ad_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
ALTER TABLE `his_assets` MODIFY `asst_id` int(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE `his_docs` MODIFY `doc_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
ALTER TABLE `his_equipments` MODIFY `eqp_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
ALTER TABLE `his_laboratory` MODIFY `lab_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
ALTER TABLE `his_medical_records` MODIFY `mdr_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
ALTER TABLE `his_patients` MODIFY `pat_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
ALTER TABLE `his_patient_transfers` MODIFY `t_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
ALTER TABLE `his_payrolls` MODIFY `pay_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
ALTER TABLE `his_pharmaceuticals` MODIFY `phar_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
ALTER TABLE `his_pharmaceuticals_categories` MODIFY `pharm_cat_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
ALTER TABLE `his_prescriptions` MODIFY `pres_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
ALTER TABLE `his_pwdresets` MODIFY `id` int(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE `his_surgery` MODIFY `s_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
ALTER TABLE `his_vendor` MODIFY `v_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
ALTER TABLE `his_vitals` MODIFY `vit_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;