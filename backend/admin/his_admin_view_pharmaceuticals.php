                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th class="px-4 py-2 text-left text-sm font-medium text-gray-700">Pharmaceutical Name</th>
                                                <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 hidden sm:table-cell">Pharmaceutical Barcode</th>
                                                <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 hidden sm:table-cell">Pharmaceutical Vendor</th>
                                                <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 hidden sm:table-cell">Pharmaceutical Category</th>
                                                <th class="px-4 py-2 text-left text-sm font-medium text-gray-700 hidden sm:table-cell">Pharmaceutical Quantity</th>
