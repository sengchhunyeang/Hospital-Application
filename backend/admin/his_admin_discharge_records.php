                        ...
                        <div class="card-box">
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <table id="patient_table"
                                       class="min-w-full border border-gray-300 divide-y divide-gray-300 text-black">
                                    <thead class="bg-gray-100">
                                    <tr>
                                        <th class="px-4 py-2 text-left text-sm font-medium">#</th>
                                        <th class="px-4 py-2 text-left text-sm font-medium">Patient Name</th>
                                        <th class="px-4 py-2 text-left text-sm font-medium hidden sm:table-cell">Patient
                                            Number
                                        </th>
                                        <th class="px-4 py-2 text-left text-sm font-medium hidden sm:table-cell">
                                            Category
                                        </th>
                                        <th class="px-4 py-2 text-left text-sm font-medium hidden sm:table-cell">WalkIn
                                            Date
                                        </th>
                                        <th class="px-4 py-2 text-left text-sm font-medium hidden sm:table-cell">WalkOut
                                            Date
                                        </th>
                                        <th class="px-4 py-2 text-left text-sm font-medium hidden sm:table-cell">Room
                                            Number
                                        </th>
                                    ...
                                    <?php
                                    $ret = "SELECT * 
                                    FROM hmisphp.his_patients 
                                   WHERE pat_type IN ('Inpatient', 'Outpatient')
                                    ORDER BY pat_walk_out_date IS NULL DESC, pat_date_joined DESC";
