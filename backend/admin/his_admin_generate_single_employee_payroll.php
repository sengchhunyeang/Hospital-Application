        ...
        <div class="row">
            ...
            <div class="col-md-4 offset-md-2">
                <div class="mt-3 float-right">
                    <p class="m-b-10"><strong>Generated Date : </strong> <span class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo date("d-m-Y - h:m:s", strtotime($mysqlDateTime)); ?> </span>
                    </p>
                    <p class="m-b-10"><strong>Payroll Status : </strong> <span class="float-right"><span
                                    class="badge badge-success"><?php echo $row->pay_status; ?></span></span></p>
        ...
        while ($row = $res->fetch_object()) {
            ...
            <div class="flex flex-wrap -mx-2 mt-5">
                ...
                <div class="w-full md:w-1/2 px-2 mb-4 md:mb-0">
                    <div class="pt-5">
                        <h6 class="text-gray-500 text-sm font-medium mb-1">Notes:</h6>
                ...
                <div class="w-full md:w-1/2 px-2">
                    <div class="text-right">
                        <p class="text-gray-700"><b>Sub-total:</b> <span class="ml-2">$ <?php echo $row->pay_emp_salary; ?></span></p>
                        <p class="text-gray-700"><b>PAYE Tax (16%) :</b> <span class="ml-2"><?php echo $taxable_salary; ?></span></p>
                        <h3 class="text-gray-800 font-semibold mt-2">$ <?php echo $total_salary; ?></h3>
                    </div>
                </div>
            ...
            <div class="mt-4 mb-1">
                <div class="text-right print:hidden">
                    <button onclick="window.print()"
                            class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
