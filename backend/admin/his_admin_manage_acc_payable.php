                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                                ...
                                                $ret="SELECT * FROM  hmisphp.his_accounts WHERE acc_type = 'Payable Account' ORDER BY RAND() ";
                                            ...
                                            ?>
                                                    ...
                                                    <tr class="hover:bg-gray-50">
                                                        ...
                                                        <td class="px-4 py-2 text-sm text-gray-700 space-x-2">
                                                            ...
                                                            <a href="his_admin_update_single_payable_account.php?acc_number=<?php echo $row->acc_number; ?>"
                                                            ...
                                                            <a href="his_admin_manage_acc_payable.php?delete_account=<?php echo $row->acc_number; ?>"
