                                    ...
                                    <div class="w-full text-center sm:text-left flex flex-col sm:flex-row items-center gap-2 text-black">
                                        <div class="hidden">
                                            <select id="demo-foo-filter-status"
                                                    class="border border-gray-300 rounded px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-black">
                                        ...
                                        <div>
                                            <input id="demo-foo-search" type="text" placeholder="Search"
                                                   class="border border-gray-300 rounded px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-black placeholder-gray-500"
                                                   autocomplete="on">
                                        </div>
                                    </div>
                                </div>
...
<!--                                demo-foo-filtering-->
                                <table id=""
                                       class="w-full border-collapse border border-gray-200 text-black"
                                       data-page-size="7">
                                    <thead>
                                    <tr class="bg-gray-100 text-black">
                                        <th class="border border-gray-200 px-4 py-2 text-black">No</th>
                                        <th class="border border-gray-200 px-4 py-2 text-black" data-toggle="true">
                                            Patient Name
                                        </th>
                                        <th class="border border-gray-200 px-4 py-2  sm:table-cell text-black ">Patient
                                            Number
                                        </th>
                                        <th class="border border-gray-200 px-4 py-2  sm:table-cell text-black">Patient
                                            Address
                                        ...
                                        <th class="border border-gray-200 px-4 py-2  sm:table-cell text-black">Action
                                        </th>
                                    </tr>
                                    </thead>
                                    <?php
                                    ...
                                    */
                                    ...
                                    while ($row = $res->fetch_object()) {
                                        ...
                                        <tr class="hover:bg-gray-50 text-black">
                                            ...
                                            <td class="border border-gray-200 px-4 py-2 hidden sm:table-cell text-black"><?php echo $row->pat_age; ?>
                                                Years
                                            </td>
                                            ...
                                            <td class="border border-gray-200 px-4 py-2 hidden sm:table-cell text-black">
                                                <a href="his_doc_view_single_patient.php?pat_id=<?php echo $row->pat_id; ?>&&pat_number=<?php echo $row->pat_number; ?>&&pat_name=<?php echo $row->pat_fname; ?>_<?php echo $row->pat_lname; ?>"
                                                   class="bg-blue-500 hover:bg-blue-700 text-white px-2 py-1 rounded text-xs inline-flex items-center">
