                                            ...
                                            while($row=$res->fetch_object())
                                            {
                                                ...
                                                <tr class="hover:bg-gray-50 text-black">
                                                    ...
                                                    <td class="border border-gray-200 px-4 py-2 hidden sm:table-cell text-black">
                                                        <a href="his_doc_view_single_patient.php?pat_id=<?php echo $row->pat_id;?>&&pat_number=<?php echo $row->pat_number;?>&&pat_name=<?php echo $row->pat_fname;?>_<?php echo $row->pat_lname;?>" class="bg-blue-500 hover:bg-blue-700 text-white px-2 py-1 rounded text-xs inline-flex items-center">
