                                            ...
                                            while($row=$res->fetch_object())
                                            {
                                                ...
                                                <tr class="hover:bg-gray-50">
                                                    ...
                                                    <td class="border border-gray-200 px-4 py-2 text-black hidden sm:table-cell">
                                                        <a href="his_doc_add_single_pres.php?pat_number=<?php echo $row->pat_number;?>" class="inline-flex items-center px-3 py-1 rounded text-xs font-medium bg-green-100 text-green-800 hover:bg-green-200">
