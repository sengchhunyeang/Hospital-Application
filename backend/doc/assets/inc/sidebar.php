<div class="left-side-menu fixed left-0 top-0 bottom-0 w-64 bg-white shadow-md z-10 transition-all duration-300">
        ...
        <div class="px-4 py-6">
            <ul class="space-y-2">
                ...
                <li>
                    <a href="his_doc_dashboard.php"
                       class="flex items-center px-3 py-2 rounded-lg transition-colors hover:bg-blue-50 hover:text-blue-600 <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_dashboard.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-700' ?>">
                ...
                <li>
                    <?php
                    $patientsActive = in_array(basename($_SERVER['PHP_SELF']), ['his_doc_register_patient.php', 'his_doc_view_patients.php', 'his_doc_manage_patient.php', //                        'his_doc_discharge_patient.php',
                        'his_doc_patient_transfer.php']);
                    ?>
                    <button type="button"
                            class="flex items-center justify-between w-full px-3 py-2 rounded-lg transition-colors hover:bg-blue-50 hover:text-blue-600 <?php echo $patientsActive ? 'bg-blue-50 text-blue-600' : 'text-gray-700' ?>"
                        ...
                        <svg class="w-4 h-4 <?php echo $patientsActive ? 'text-blue-500 rotate-180' : 'text-gray-500' ?> transform transition-transform"
                             fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <ul class="mt-1 pl-8 space-y-1 <?php echo $patientsActive ? '' : 'hidden' ?>"
                        aria-hidden="<?php echo $patientsActive ? 'false' : 'true' ?>">
                        <li>
                            <a href="his_doc_register_patient.php"
                               class="block whitespace-nowrap px-3 py-2 rounded-lg transition-colors hover:bg-blue-50 hover:text-blue-600 <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_register_patient.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                                Register Patient
                            </a>
                        </li>
                        <li>
                            <a href="his_doc_view_patients.php"
                               class="block whitespace-nowrap px-3 py-2 rounded-lg transition-colors hover:bg-blue-50 hover:text-blue-600 <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_view_patients.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                                View Patients
                            </a>
                        </li>
                        <li>
                            <a href="his_doc_manage_patient.php"
                               class="block whitespace-nowrap text-sm px-3 py-2 rounded-lg transition-colors hover:bg-blue-50 hover:text-blue-600 <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_manage_patient.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                                Manage Patients
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="his_doc_patient_transfer.php"
                               class="block whitespace-nowrap px-3 py-2 rounded-lg transition-colors hover:bg-blue-50 hover:text-blue-600 <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_patient_transfer.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                                Patient Transfers
                            </a>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    ?>
                    <button type="button"
                            class="flex items-center justify-between w-full px-3 py-2 rounded-lg transition-colors hover:bg-blue-50 hover:text-blue-600 <?php echo $pharmacyActive ? 'bg-blue-50 text-blue-600' : 'text-gray-700' ?>"
                        ...
                        <svg class="w-4 h-4 <?php echo $pharmacyActive ? 'text-blue-500 rotate-180' : 'text-gray-500' ?> transform transition-transform"
                             fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <ul class="mt-1 space-y-1 pl-8 <?php echo $pharmacyActive ? '' : 'hidden' ?>"
                        aria-hidden="<?php echo $pharmacyActive ? 'false' : 'true' ?>">
                        <li>
                            <a href="his_doc_add_pharm_cat.php"
                               class="block text-xs text-center whitespace-nowrap px-3 py-2 rounded-lg transition-colors
           hover:bg-blue-50 hover:text-blue-600
           <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_add_pharm_cat.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                                Add Pharm Category
                            </a>
                        </li>
                        <li>
                            <a href="his_doc_view_pharm_cat.php"
                               class="block text-xs text-center whitespace-nowrap px-3 py-2 rounded-lg transition-colors
           hover:bg-blue-50 hover:text-blue-600
           <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_view_pharm_cat.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                                View Pharm Category
                            </a>
                        </li>
                        <li>
                            <a href="his_doc_manage_pharm_cat.php"
                               class="block text-xs text-center whitespace-nowrap px-3 py-2 rounded-lg transition-colors
           hover:bg-blue-50 hover:text-blue-600
           <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_manage_pharm_cat.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                                Manage Pharm Category
                            </a>
                        </li>
                        <li class="border-t border-gray-200 my-1"></li>
                        <li>
                            <a href="his_doc_add_pharmaceuticals.php"
                               class="block text-xs text-center whitespace-nowrap px-3 py-2 rounded-lg transition-colors
           hover:bg-blue-50 hover:text-blue-600
           <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_add_pharmaceuticals.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                                Add Pharmaceuticals
                            </a>
                        </li>
                        <li>
                            <a href="his_doc_view_pharmaceuticals.php"
                               class="block text-xs text-center whitespace-nowrap px-3 py-2 rounded-lg transition-colors
           hover:bg-blue-50 hover:text-blue-600
           <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_view_pharmaceuticals.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                        ...
                        <li>
                            <a href="his_doc_manage_pharmaceuticals.php"
                               class="block text-xs text-center whitespace-nowrap px-3 py-2 rounded-lg transition-colors
           hover:bg-blue-50 hover:text-blue-600
           <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_manage_pharmaceuticals.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                        ...
                        <li>
                            <a href="his_doc_add_presc.php"
                               class="block text-xs text-center whitespace-nowrap px-3 py-2 rounded-lg transition-colors
           hover:bg-blue-50 hover:text-blue-600
           <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_add_presc.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                                Add Prescriptions
                            </a>
                        </li>
                        <li>
                            <a href="his_doc_view_presc.php"
                               class="block text-xs text-center whitespace-nowrap px-3 py-2 rounded-lg transition-colors
           hover:bg-blue-50 hover:text-blue-600
           <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_view_presc.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                                View Prescriptions
                            </a>
                        </li>
                        <li>
                            <a href="his_doc_manage_presc.php"
                               class="block text-xs text-center whitespace-nowrap px-3 py-2 rounded-lg transition-colors
           hover:bg-blue-50 hover:text-blue-600
           <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_manage_presc.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">
                ...
                <li>
                    ...
                    ?>
                    <button type="button"
                            class="flex items-center justify-between w-full px-3 py-2 rounded-lg transition-colors hover:bg-blue-50 hover:text-blue-600 <?php echo $labActive ? 'bg-blue-50 text-blue-600' : 'text-gray-700' ?>"
                        ...
                        <svg class="w-4 h-4 <?php echo $labActive ? 'text-blue-500 rotate-180' : 'text-gray-500' ?> transform transition-transform"
                             fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <ul class="mt-1 pl-8 space-y-1 text-xs <?php echo $labActive ? '' : 'hidden' ?>"
                        aria-hidden="<?php echo $labActive ? 'false' : 'true' ?>">
                        <li>
                            <a href="his_doc_patient_lab_test.php"
                               class="block whitespace-nowrap px-3 py-2 rounded-lg transition-colors text-gray-600 hover:bg-blue-50 hover:text-blue-600
           ...
           <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_lab_report.php' ? 'bg-blue-50 text-blue-600' : '' ?>">
                ...
                <li>
                    ...
                    ?>
                    <button type="button"
                            class="flex items-center justify-between w-full px-3 py-2 rounded-lg transition-colors hover:bg-blue-50 hover:text-blue-600 <?php echo $payrollActive ? 'bg-blue-50 text-blue-600' : 'text-gray-700' ?>"
                            aria-expanded="<?php echo $payrollActive ? 'true' : 'false' ?>">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 <?php echo $payrollActive ? 'text-blue-500' : 'text-gray-500' ?>"
                                 fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg class="w-4 h-4 <?php echo $payrollActive ? 'text-blue-500 rotate-180' : 'text-gray-500' ?> transform transition-transform"
                             fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </button>
                    <ul class="mt-1 pl-8 space-y-1 <?php echo $payrollActive ? '' : 'hidden' ?>"
                        aria-hidden="<?php echo $payrollActive ? 'false' : 'true' ?>">
                        <li><a href="his_doc_view_payrolls.php"
                               class="block px-3 py-2 rounded-lg transition-colors hover:bg-blue-50 hover:text-blue-600 <?php echo basename($_SERVER['PHP_SELF']) == 'his_doc_view_payrolls.php' ? 'bg-blue-50 text-blue-600' : 'text-gray-600' ?>">My
                                Payrolls</a></li>
                    </ul>
                </li>
            </ul>
