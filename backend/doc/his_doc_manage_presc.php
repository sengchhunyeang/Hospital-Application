                                            ...
                                            while($row=$res->fetch_object())
                                            {
                                                ...
                                                <tr class="hover:bg-gray-50">
                                                    ...
                                                    <td class="border border-gray-200 px-4 py-2 hidden sm:table-cell space-x-2">
                                                        ...
                                                        <a href="his_doc_upate_single_pres.php?pres_number=<?php echo $row->pres_number;?>" class="inline-flex items-center px-3 py-1 rounded text-xs font-medium bg-yellow-100 text-yellow-800 hover:bg-yellow-200">
                                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
