                                            ...
                                            <div class="col-12 text-sm-center form-inline" >
                                                ...
                                                <div class="">
                                                    <input
                                                            ...
                                                            placeholder="Search"
                                                            autocomplete="on"
                                                            class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-700 placeholder-gray-400
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th class="px-4 py-2 text-left text-sm font-semibold">Patient Category</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                    ...
                                                    <tr class="hover:bg-gray-50">
                                                        ...
                                                        <td class="px-4 py-2 text-sm text-gray-700"><?php echo $row->pat_ailment; ?></td>
                                                        <td class="px-4 py-2 text-sm text-gray-700"><?php echo $row->pat_age; ?> Years</td>
                                                        <td class="px-4 py-2 text-sm text-gray-700"><?php echo $row->pat_type; ?></td>
                                                        <td class="px-4 py-2">
                                                            <a href="his_doc_add_single_patient_vitals.php?pat_number=<?php echo $row->pat_number; ?>"
